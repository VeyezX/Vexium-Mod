...
import veyezx.mod.objects.blocks.item.ItemBlockVariants;
import veyezx.mod.util.IHasModel;
import veyezx.mod.util.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public BlockOres(String name, String dimension) 
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.VEXIUM));
